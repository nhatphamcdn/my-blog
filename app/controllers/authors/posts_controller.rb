module Authors
  class PostsController < AuthorController
    ...
    # GET /posts.json
    def index
      @posts = current_user.posts.order_published.most_recent
    end
    ...
    def publish
      @post.publish
      redirect_to authors_posts_url, notice: 'Have published post.'
    end

    def unpublish
      @post.unpublish
      redirect_to authors_posts_url, notice: 'Upublished post.'
    end
